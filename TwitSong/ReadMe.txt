#TwitMySong -- v1.0.0.x [BETA] 
fcomputer 2013. follow @TwitMySong.
...
Menemukan BUGS ? Segera laporkan bugs yang anda temukan, dengan email (xtfcomp@gmail.com) atau mention via Twitter @TwitMySong.
Nama anda akan masuk kedalam list Bug Reporter setiap bug yang anda laporkan! Terima kasih banyak telah melaporkan :)

STAY UPDATE, FOLLOW @TwitMySong
...
Found some BUGS ? Report it via email (xtfcomp@gmail.com) or you can mention via Twitter @TwitMySong.
